...
class BaseMetric(metaclass=ABCMeta):
    ...
    def evaluate(self, size: int) -> dict:
        ...
        if is_main_process():
            ...
            if hasattr(self, 'results_saveroot') and (self.results_saveroot is not None):
                import pickle, os
                with open(os.path.join(self.results_saveroot, 'cls_accuracy_pred_rst.pkl'), 'wb') as tem:
                    pickle.dump(results, tem)
