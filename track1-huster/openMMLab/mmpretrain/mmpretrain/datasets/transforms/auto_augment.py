...
AUTOAUG_POLICIES = {
    ...
    'imagenet': [
        [dict(type='mmpretrain.Posterize', bits=4, prob=0.4),             dict(type='mmpretrain.Rotate', angle=30., prob=0.6)],
        [dict(type='mmpretrain.Solarize', thr=256 / 9 * 4, prob=0.6),     dict(type='mmpretrain.AutoContrast', prob=0.6)],
        [dict(type='mmpretrain.Equalize', prob=0.8),                      dict(type='mmpretrain.Equalize', prob=0.6)],
        [dict(type='mmpretrain.Posterize', bits=5, prob=0.6),             dict(type='mmpretrain.Posterize', bits=5, prob=0.6)],
        [dict(type='mmpretrain.Equalize', prob=0.4),                      dict(type='mmpretrain.Solarize', thr=256 / 9 * 5, prob=0.2)],
        [dict(type='mmpretrain.Equalize', prob=0.4),                      dict(type='mmpretrain.Rotate', angle=30 / 9 * 8, prob=0.8)],
        [dict(type='mmpretrain.Solarize', thr=256 / 9 * 6, prob=0.6),     dict(type='mmpretrain.Equalize', prob=0.6)],
        [dict(type='mmpretrain.Posterize', bits=6, prob=0.8),             dict(type='mmpretrain.Equalize', prob=1.)],
        [dict(type='mmpretrain.Rotate', angle=10., prob=0.2),             dict(type='mmpretrain.Solarize', thr=256 / 9, prob=0.6)],
        [dict(type='mmpretrain.Equalize', prob=0.6),                      dict(type='mmpretrain.Posterize', bits=5, prob=0.4)],
        [dict(type='mmpretrain.Rotate', angle=30 / 9 * 8, prob=0.8),      dict(type='mmpretrain.ColorTransform', magnitude=0., prob=0.4)],
        [dict(type='mmpretrain.Rotate', angle=30., prob=0.4),             dict(type='mmpretrain.Equalize', prob=0.6)],
        [dict(type='mmpretrain.Equalize', prob=0.0),                      dict(type='mmpretrain.Equalize', prob=0.8)],
        [dict(type='mmpretrain.Invert', prob=0.6),                        dict(type='mmpretrain.Equalize', prob=1.)],
        [dict(type='mmpretrain.ColorTransform', magnitude=0.4, prob=0.6), dict(type='mmpretrain.Contrast', magnitude=0.8, prob=1.)],
        [dict(type='mmpretrain.Rotate', angle=30 / 9 * 8, prob=0.8),      dict(type='mmpretrain.ColorTransform', magnitude=0.2, prob=1.)],
        [dict(type='mmpretrain.ColorTransform', magnitude=0.8, prob=0.8), dict(type='mmpretrain.Solarize', thr=256 / 9 * 2, prob=0.8)],
        [dict(type='mmpretrain.Sharpness', magnitude=0.7, prob=0.4),      dict(type='mmpretrain.Invert', prob=0.6)],
        [dict(type='mmpretrain.Shear', magnitude=0.3 / 9 * 5, prob=0.6, direction='horizontal'), dict(type='mmpretrain.Equalize', prob=1.)],
        [dict(type='mmpretrain.ColorTransform', magnitude=0., prob=0.4),  dict(type='mmpretrain.Equalize', prob=0.6)],
        [dict(type='mmpretrain.Equalize', prob=0.4),                      dict(type='mmpretrain.Solarize', thr=256 / 9 * 5, prob=0.2)],
        [dict(type='mmpretrain.Solarize', thr=256 / 9 * 4, prob=0.6),     dict(type='mmpretrain.AutoContrast', prob=0.6)],
        [dict(type='mmpretrain.Invert', prob=0.6),                        dict(type='mmpretrain.Equalize', prob=1.)],
        [dict(type='mmpretrain.ColorTransform', magnitude=0.4, prob=0.6), dict(type='mmpretrain.Contrast', magnitude=0.8, prob=1.)],
...
RANDAUG_POLICIES = {
    ...
    'timm_increasing': [
        ...
        dict(type='mmpretrain.Rotate', magnitude_range=(0, 30)),
        dict(type='mmpretrain.Posterize', magnitude_range=(4, 0)),
        dict(type='mmpretrain.Solarize', magnitude_range=(256, 0)),
        dict(type='mmpretrain.SolarizeAdd', magnitude_range=(0, 110)),
        dict(type='mmpretrain.ColorTransform', magnitude_range=(0, 0.9)),
        dict(type='mmpretrain.Contrast', magnitude_range=(0, 0.9)),
        dict(type='mmpretrain.Brightness', magnitude_range=(0, 0.9)),
        dict(type='mmpretrain.Sharpness', magnitude_range=(0, 0.9)),
        dict(type='mmpretrain.Shear', magnitude_range=(0, 0.3), direction='horizontal'),
        dict(type='mmpretrain.Shear', magnitude_range=(0, 0.3), direction='vertical'),
        dict(type='mmpretrain.Translate', magnitude_range=(0, 0.45), direction='horizontal'),
        dict(type='mmpretrain.Translate', magnitude_range=(0, 0.45), direction='vertical'),
    ],
}
