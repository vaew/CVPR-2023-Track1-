...
class DETRHead(BaseModule):
    ...
    def _get_targets_single(self, cls_score: Tensor, bbox_pred: Tensor,
        ...
        #if bbox_targets.dtype == torch.float16:
        #    pos_gt_bboxes_targets = pos_gt_bboxes_targets.half()
        bbox_targets = bbox_targets.float()
        bbox_targets[pos_inds] = pos_gt_bboxes_targets # amp时出现问题，index赋值时dst和src的dtype需要一致。bbox_targets是half, pos_gt_bbox_targets是float
